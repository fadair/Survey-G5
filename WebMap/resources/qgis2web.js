...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 28,
        minZoom: 14,
        extent: [257204.582029, 662076.202686, 260981.629718, 665202.197350],
        projection: new ol.proj.Projection({
            code: 'EPSG:27700',
            //extent: [257453.999600, 662299.198800, 260579.603300, 664843.179700],
            units: 'm'
        })
    })
});
...
map.getView().fit([257204.582029, 662076.202686, 260981.629718, 665202.197350], map.getSize());
